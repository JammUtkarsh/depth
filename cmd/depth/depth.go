...
func parse(args []string) (*depth.Tree, []string) {
	...
	f.BoolVar(&t.OutputStdLib, "std", false, "If set, excludes dependencies from the standard library.") // update
	f.BoolVar(&t.Version, "v", false, "If set, includes version of external dependencies.")  // update
